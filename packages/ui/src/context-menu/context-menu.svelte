<script lang="ts">
    ...
    const getOptionClasses = ({ destructive, onClick }: Option) =>
        twMerge(
            'ui-flex ui-w-full ui-items-center ui-gap-2 ui-rounded-md ui-px-3 ui-py-2 ui-text-left ui-text-sm ui-transition-colors ui-duration-100 disabled:ui-cursor-not-allowed disabled:ui-text-surface-400 disabled:hover:ui-bg-transparent aria-disabled:ui-cursor-not-allowed aria-disabled:ui-text-surface-400 aria-disabled:hover:ui-bg-transparent',
